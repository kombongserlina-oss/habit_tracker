      ...
      child: Consumer<AddHabitDialogController>(
          builder: (ctx, controller, child) {
            return AlertDialog(
              ...
              // PERBAIKAN: Menggunakan colorScheme.surface menggantikan backgroundColor lama
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Add Habit",
                        // PERBAIKAN: Menggunakan displayMedium menggantikan headline2
                    ...
                    Center(
                      child: Text(
                        "Icon",
                        // PERBAIKAN: Menggunakan bodyMedium menggantikan bodyText2
